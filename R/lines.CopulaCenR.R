...
#' @param plotly_object only for class = "joint", an object of plot.CopulaCenR
...
#'
#' If class = "marginal", one needs to specify which margin to plot through the argument plot_margin. \cr
#'
#' If class = "joint", one needs to include a plot_ly object (from plot.CopulaCenR with class = "joint") through the argument plotly_object .\cr
#'
...
lines.CopulaCenR <- function(x, y, class = "joint", newdata, evalPoints = 50, evalTimes = NULL, plot_margin = 1, cond_time = NULL, cond_margin = 2, plotly_object = NULL, ...) {
